...
public:
	...
	GAMEPADUMG_API static void EnableAnalogCursor(class APlayerController* PC, TSharedPtr<SWidget> WidgetToFocus);
	GAMEPADUMG_API static void DisableAnalogCursor(class APlayerController* PC);
